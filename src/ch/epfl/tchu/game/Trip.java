...
/**
 * The Trip class, public, final and immutable,
...
public final class Trip {
	 ...
	 *
	 * @param from   the departure Stations of the Trips.
	 * @param to     the arrival Stations of the Trips.
	 * @param points points attributed to the Trips.
	 * @return all the Trips possible from a Station of the first list "from"
	 ...
	 *
	 * @param from   the departure Station of the Trip.
	 * @param to     the arrival Station of the Trip.
	 * @param points the number of points associated to the Trip.
	 ...
	 *
	 * @return from the departure Station of the Trip.
	 */
	public Station from() {
		return from;
	}
	 ...
	 *
	 * @return to the arrival Station of the Trip.
	 */
	public Station to() {
		return to;
	}
	 ...
	 *
	 * @return points the points attributed to the Trip.
	 */
	public int points() {
		return points;
	}
	 ...
	 *
	 * @param connectivity
	 * @return points if the Stations are connected, - points if not.
	 */
